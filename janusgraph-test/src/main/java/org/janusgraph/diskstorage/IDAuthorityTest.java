...
public abstract class IDAuthorityTest {
    ...
    public static Stream<Arguments> configs() {
        ...
        configurations.add(arguments(c.getConfiguration()));
    ...
    public int uidBitWidth;
    public boolean hasFixedUid;
    public boolean hasEmptyUid;
    public long blockSize;
    public long idUpperBoundBitWidth;
    public long idUpperBound;
